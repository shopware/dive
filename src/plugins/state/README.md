...
| [GetObjectsAction](src/actions/object/getobjects.ts) | Returns a list of objects of given IDs. | <code>{ ids: string[] }</code> | <code>[EntitySchema](https///github.com:shopware/dive/blob/main/src/plugins/state/src/State.ts)[]</code> |
