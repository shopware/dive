...
var Xt = (a, i, t) => i in a ? zt(a, i, { enumerable: !0, configurable: !0, writable: !0, value: t }) : a[i] = t;
var c = (a, i, t) => Xt(a, typeof i != "symbol" ? i + "" : i, t);
import { Vector2 as it, Raycaster as bt, Vector3 as r, Object3D as ot, Quaternion as E, MeshBasicMaterial as St, LineBasicMaterial as Yt, CylinderGeometry as w, BoxGeometry as f, BufferGeometry as lt, Float32BufferAttribute as ht, Mesh as o, OctahedronGeometry as V, Line as I, TorusGeometry as L, SphereGeometry as Qt, Euler as Ct, Matrix4 as vt, PlaneGeometry as Zt, DoubleSide as Ht } from "three";
import { P as Lt, U as Ot } from "./VisibilityLayerMask-BAKNt1Mg.mjs";
...
const Rt = "#c20017", kt = "#00ab26", Gt = "#0081d4", ct = Rt, dt = kt, pt = Gt;
function $(a, i) {
  return a ? i in a : !1;
}
function et(a, i) {
  if (a)
    return $(a, i) ? a : et(a.parent, i);
}
class qt {
  constructor(i, t) {
    ...
    this.name = "BaseTool", this._canvas = t.domElement, this._scene = i, this._controller = t, this._pointer = new it(), this._pointerPrimaryDown = !1, this._pointerMiddleDown = !1, this._pointerSecondaryDown = !1, this._lastPointerDown = new it(), this._lastPointerUp = new it(), this._raycaster = new bt(), this._raycaster.layers.mask = Lt | Ot, this._intersects = [], this._hovered = null, this._dragging = !1, this._dragStart = new r(), this._dragCurrent = new r(), this._dragEnd = new r(), this._dragDelta = new r(), this._draggable = null, this._dragRaycastOnObjects = null;
  }
  get _pointerAnyDown() {
  ...
  onPointerDown(i) {
    ...
    this._lastPointerDown.copy(this._pointer), this._draggable = et(
...
const z = new bt(), u = new r(), A = new r(), d = new E(), ut = {
  X: new r(1, 0, 0),
  Y: new r(0, 1, 0),
  Z: new r(0, 0, 1)
}, nt = { type: "change" }, mt = { type: "mouseDown" }, ft = { type: "mouseUp", mode: null }, _t = { type: "objectChange" };
class Wt extends ot {
  constructor(i, t) {
    ...
    function e(m, b) {
      ...
      Object.defineProperty(l, m, {
        ...
        set: function(T) {
          Q !== T && (Q = T, s[m] = T, n[m] = T, l.dispatchEvent({ type: m + "-changed", value: T }), l.dispatchEvent(nt));
        }
      }), l[m] = b, s[m] = b, n[m] = b;
    }
    ...
    const p = new r(), g = new r(), j = new E(), Y = new E(), Z = new r(), H = new E(), at = new r(), q = new r(), M = new r(), x = 0, v = new r();
    e("worldPosition", p), e("worldPositionStart", g), e("worldQuaternion", j), e("worldQuaternionStart", Y), e("cameraPosition", Z), e("cameraQuaternion", H), e("pointStart", at), e("pointEnd", q), e("rotationAxis", M), e("rotationAngle", x), e("eye", v), this._offset = new r(), this._startNorm = new r(), this._endNorm = new r(), this._cameraScale = new r(), this._parentPosition = new r(), this._parentQuaternion = new E(), this._parentQuaternionInv = new E(), this._parentScale = new r(), this._worldScaleStart = new r(), this._worldQuaternionInv = new E(), this._worldScale = new r(), this._positionStart = new r(), this._quaternionStart = new E(), this._scaleStart = new r(), this._getPointer = Ft.bind(this), this._onPointerDown = Bt.bind(this), this._onPointerHover = Ut.bind(this), this._onPointerMove = Vt.bind(this), this._onPointerUp = Nt.bind(this), this.domElement.addEventListener("pointerdown", this._onPointerDown), this.domElement.addEventListener("pointermove", this._onPointerHover), this.domElement.addEventListener("pointerup", this._onPointerUp);
  }
  ...
  pointerHover(i) {
    ...
    i !== null && z.setFromCamera(i, this.camera);
    const t = st(this._gizmo.picker[this.mode], z);
    t ? this.axis = t.object.name : this.axis = null;
  }
  pointerDown(i) {
    if (!(this.object === void 0 || this.dragging === !0 || i != null && i.button !== 0) && this.axis !== null) {
      i !== null && z.setFromCamera(i, this.camera);
      const t = st(this._plane, z, !0);
  ...
  pointerMove(i) {
    ...
    if (e) {
      ...
      this.dispatchEvent(nt), this.dispatchEvent(_t);
    }
  }
  pointerUp(i) {
  ...
  reset() {
    this.enabled && this.dragging && (this.object.position.copy(this._positionStart), this.object.quaternion.copy(this._quaternionStart), this.object.scale.copy(this._scaleStart), this.dispatchEvent(nt), this.dispatchEvent(_t), this.pointStart.copy(this.pointEnd));
  }
  getRaycaster() {
    return z;
  }
...
function Ft(a) {
    ...
    };
  {
    ...
    return {
      x: (a.clientX - i.left) / i.width * 2 - 1,
      y: -(a.clientY - i.top) / i.height * 2 + 1,
      button: a.button
    };
  }
}
...
function st(a, i, t) {
  const n = i.intersectObject(a, !0);
  for (let s = 0; s < n.length; s++)
    if (n[s].object.visible || t)
      return n[s];
  return !1;
}
const N = new Ct(), h = new r(0, 1, 0), wt = new r(0, 0, 0), gt = new vt(), K = new E(), tt = new E(), P = new r(), yt = new vt(), k = new r(1, 0, 0), X = new r(0, 1, 0), G = new r(0, 0, 1), J = new r(), O = new r(), R = new r();
class Kt extends ot {
  constructor() {
    ...
    Z.opacity = 0.25;
    const H = i.clone();
    H.color.setHex(16776960), H.opacity = 0.25, i.clone().color.setHex(16776960);
    const q = i.clone();
    ...
    function b(y, W) {
      const S = new L(y, 75e-4, 3, 64, W * Math.PI * 2);
    ...
    const T = {
      ...
      XYZ: [
        [new o(new V(0.1, 0), Z.clone()), [0, 0, 0]]
      ],
      XY: [
      ...
      XZ: [
        [new o(new f(0.15, 0.15, 0.01), j.clone()), [0.15, 0, 0.15], [-Math.PI / 2, 0, 0]]
      ]
    }, Pt = {
      X: [
      ...
      START: [
        [new o(new V(0.01, 2), s), null, null, null, "helper"]
      ],
      END: [
        [new o(new V(0.01, 2), s), null, null, null, "helper"]
      ],
      ...
      E: [
        [new o(b(0.75, 1), H), null, [0, Math.PI / 2, 0]]
      ]
    }, xt = {
      AXIS: [
        [new I(v, s.clone()), [-1e3, 0, 0], null, [1e6, 1, 1], "helper"]
      ...
      X: [
        [new o(new L(0.5, 0.1, 4, 24), n), [0, 0, 0], [0, -Math.PI / 2, -Math.PI / 2]]
      ],
      Y: [
        [new o(new L(0.5, 0.1, 4, 24), n), [0, 0, 0], [Math.PI / 2, 0, 0]]
      ],
      Z: [
        [new o(new L(0.5, 0.1, 4, 24), n), [0, 0, 0], [0, 0, -Math.PI / 2]]
      ],
      E: [
        [new o(new L(0.75, 0.1, 2, 24), n)]
      ]
    }, It = {
      X: [
      ...
      XZ: [
        [new o(new f(0.15, 0.15, 0.01), j), [0.15, 0, 0.15], [-Math.PI / 2, 0, 0]]
      ],
      XYZ: [
        [new o(new f(0.1, 0.1, 0.1), Z.clone())]
      ]
    }, At = {
      X: [
        [new o(new w(0.2, 0, 0.6, 4), n), [0.3, 0, 0], [0, 0, -Math.PI / 2]],
    ...
    function D(y) {
      const W = new ot();
      for (const S in y)
        for (let C = y[S].length; C--; ) {
          const _ = y[S][C][0].clone(), F = y[S][C][1], U = y[S][C][2], B = y[S][C][3], Tt = y[S][C][4];
          _.name = S, _.tag = Tt, F && _.position.set(F[0], F[1], F[2]), U && _.rotation.set(U[0], U[1], U[2]), B && _.scale.set(B[0], B[1], B[2]), _.updateMatrix();
    ...
    this.gizmo = {}, this.picker = {}, this.helper = {}, this.add(this.gizmo.translate = D(T)), this.add(this.gizmo.rotate = D(Mt)), this.add(this.gizmo.scale = D(It)), this.add(this.picker.translate = D(Pt)), this.add(this.picker.rotate = D(Dt)), this.add(this.picker.scale = D(At)), this.add(this.helper.translate = D(Et)), this.add(this.helper.rotate = D(xt)), this.add(this.helper.scale = D(jt)), this.picker.translate.visible = !1, this.picker.rotate.visible = !1, this.picker.scale.visible = !1;
  }
  // updateMatrixWorld will update transformations and appearance of individual handles
  updateMatrixWorld(i) {
    const n = (this.mode === "scale" ? "local" : this.space) === "local" ? this.worldQuaternion : tt;
...
class Jt extends o {
  constructor() {
    super(
      new Zt(1e5, 1e5, 2, 2),
      new St({ visible: !1, wireframe: !0, side: Ht, transparent: !0, opacity: 0.1, toneMapped: !1 })
    ), this.isTransformControlsPlane = !0, this.type = "TransformControlsPlane";
  }
  updateMatrixWorld(i) {
    let t = this.space;
    switch (this.position.copy(this.worldPosition), this.mode === "scale" && (t = "local"), J.copy(k).applyQuaternion(t === "local" ? this.worldQuaternion : tt), O.copy(X).applyQuaternion(t === "local" ? this.worldQuaternion : tt), R.copy(G).applyQuaternion(t === "local" ? this.worldQuaternion : tt), h.copy(O), this.mode) {
      case "translate":
      case "scale":
        switch (this.axis) {
          case "X":
            ...
            break;
          case "Y":
            h.copy(this.eye).cross(O), P.copy(O).cross(h);
            break;
          case "Z":
...
class $t extends qt {
  ...
  initGizmo() {
    ...
    return t.mode = "translate", t.traverse((n) => {
      ...
      this._controller.enabled = !1, $(t.object, "isMovable") && t.object.onMoveStart && t.object.onMoveStart();
    }), t.addEventListener("objectChange", () => {
      if ($(t.object, "isMovable") && t.object.onMove && (t.object.onMove(), this._scaleLinked)) {
        const n = t.object.scale, s = (n.x + n.y + n.z) / 3;
        t.object.scale.set(s, s, s);
      }
    }), t.addEventListener("mouseUp", () => {
      this._controller.enabled = !0, $(t.object, "isMovable") && t.object.onMoveEnd && t.object.onMoveEnd();
    }), t;
  }
}
const ne = (a) => a.isSelectTool !== void 0;
class se extends $t {
  constructor(t, n) {
    super(t, n);
  ...
  onClick(t) {
    super.onClick(t);
    const n = this._raycaster.intersectObjects(this._scene.Root.children, !0).filter((l) => l.object.visible)[0], s = et(
