 ...
 * @module
 */
declare class DIVECommunication extends CommandRunner {
    ...
    private getObjects;
    addObject(payload: Actions['ADD_OBJECT']['PAYLOAD']): Actions['ADD_OBJECT']['RETURN'];
    private updateObject;
    deleteObject(payload: Actions['DELETE_OBJECT']['PAYLOAD']): Actions['DELETE_OBJECT']['RETURN'];
