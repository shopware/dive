...
declare const ModuleRegistry: {
    ...
    readonly AssetConverter: () => Promise<typeof import('./assetconverter/AssetConverter.ts').AssetConverter>;
    readonly AssetExporter: () => Promise<typeof import('./assetexporter/AssetExporter.ts').AssetExporter>;
    readonly AssetLoader: () => Promise<typeof import('./assetloader/AssetLoader.ts').AssetLoader>;
