...
class Ct {
  ...
  getMaterialType(e) {
    ...
    return !o.extensions || !o.extensions[this.name] ? null : D;
  }
  extendMaterialParams(e, t) {
...
class Pt {
  ...
  extendMaterialParams(e, t) {
    ...
    return t.attenuationColor = new U().setRGB(a[0], a[1], a[2], O), Promise.all(r);
  }
}
class kt {
  constructor(e) {
...
class Ft {
  ...
  extendMaterialParams(e, t) {
    ...
    return t.specularColor = new U().setRGB(a[0], a[1], a[2], O), s.specularColorTexture !== void 0 && r.push(o.assignTexture(t, "specularColorMap", s.specularColorTexture, N)), Promise.all(r);
  }
}
class Ut {
  constructor(e) {
...
class sn {
  ...
  loadMaterial(e) {
    ...
    if (r.occlusionTexture !== void 0 && s !== W && (c.push(t.assignTexture(a, "aoMap", r.occlusionTexture)), r.occlusionTexture.strength !== void 0 && (a.aoMapIntensity = r.occlusionTexture.strength)), r.emissiveFactor !== void 0 && s !== W) {
      ...
      a.emissive = new U().setRGB(l[0], l[1], l[2], O);
    }
...
function Se(d, e, t) {
  ...
  return ge.workingColorSpace !== O && "COLOR_0" in o && console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${ge.workingColorSpace}" not supported.`), F(d, e), rn(d, e, t), Promise.all(n).then(function() {
...
const se = {
  LOAD_DRACO_JS_DECODER: async () => (await import("../../../../chunks/draco_decoder-CEzwqP9o.mjs")).default,
  LOAD_DRACO_WASM_WRAPPER: async () => (await import("../../../../chunks/draco_wasm_wrapper-yQy2VLhb.mjs")).default,
  LOAD_DRACO_WASM_DECODER: async () => {
    const d = (await import("../../../../chunks/draco_decoder-DtHHc5d0.mjs")).default;
